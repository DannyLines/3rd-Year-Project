...
def preprocess(df):
    new_df = df.copy()
    new_df['H_home_acc'] = (new_df['H_home_target'] / new_df['H_home_attempts'])
    new_df['H_home_acc'] = new_df['H_home_acc'].replace([np.inf, -np.inf], np.nan)
    new_df['H_home_acc'] = new_df['H_home_acc'].fillna(0)
    ...
    new_df['H_away_acc'] = (new_df['H_away_target'] / new_df['H_away_attempts'])
    new_df['H_away_acc'] = new_df['H_away_acc'].replace([np.inf, -np.inf], np.nan)
    new_df['H_away_acc'] = new_df['H_away_acc'] = new_df['H_away_acc'].fillna(0)
...
def main():
    ...
    data = data[['HomeTeam', 'AwayTeam', 'H_result', 'home_GF', 'home_GA', 'home_GD', 'home_points',
                                 'away_GF', 'away_GA', 'away_GD', 'away_points', 'H_home_sentiment', 'H_away_sentiment',
